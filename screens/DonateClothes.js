...
const DonateFood=({navigation})=>{
    ...
    const handleobjectsdonation=()=>{
        if (title==''||desc==''||category==''||phoneno=='' ){
            ...
            createdonateObjectsDocument(name,title,desc,category,phoneno,location);
        }
        }
        const createdonateObjectsDocument =async (name,title,desc,category,phoneno,location)=>{
