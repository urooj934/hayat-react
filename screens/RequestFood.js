...
const RequestFood=({navigation})=>{
    ...
    const handlePostReq=()=>{
        ...
        createReqFoodDocument(name,title,desc,category,phoneno,);}
        }
    const createReqFoodDocument =async (name,title,desc,category,phoneno,address)=>{
  ...
  <TextInput placeholder="Details"  placeholderTextColor={'#c5c8c9'} 
  value={desc}
