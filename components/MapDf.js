...
<Text style={styles.text}>current location :{text}
  ...
  <KeyboardAvoidingView
      behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.action}> 
<FontAwesome name="map-pin" size={20} color="#05375A"/>
  <TextInput placeholder="Enter detailed address" placeholderTextColor={'#c5c8c9'} autoComplete={false}
  value={address}
  onChangeText={value=>setAddress(value)}
  autoCorrect={false}
  style={styles.textInput}></TextInput>
  <View style={{flexDirection:"row"}}>
   <FontAwesome name="info" size={20} color="#c5c8c9"/>
   <Text style={{color:"#c5c8c9"}}>Make sure to enter your precise address</Text>
   </View>
  </KeyboardAvoidingView>
